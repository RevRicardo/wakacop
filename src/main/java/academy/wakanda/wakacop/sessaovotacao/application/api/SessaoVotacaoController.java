...
public class SessaoVotacaoController implements SessaoVotacaoAPI {
    ...
    public VotoResponse recebeVoto(UUID idSessao, VotoRequest novoVoto) {
        log.info("[inicia] SessaoVotacaoService --> recebeVoto");
        log.info("[idSessao] {}", idSessao);
        VotoResponse votoResponse = sessaoVotacaoService.recebeVoto(idSessao, novoVoto);
        log.info("[finaliza] SessaoVotacaoService --> recebeVoto");
        return votoResponse;
    }

    @Override
    public ResuladoSesaoResponse obtemResultado(UUID idSessao) {
        log.info("[Inicia] SessaoVotacaoController ==> obtemResultado");
        ResuladoSesaoResponse resultado = sessaoVotacaoService.obtemResultado(idSessao);
