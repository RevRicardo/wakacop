...
import academy.wakanda.wakacop.sessaovotacao.application.api.ResuladoSesaoResponse;
...
public class SessaoVotacao {
    ...
    public ResuladoSesaoResponse obtemResultado() {
        atualizaStatus();
        return new ResuladoSesaoResponse(this);
    }
